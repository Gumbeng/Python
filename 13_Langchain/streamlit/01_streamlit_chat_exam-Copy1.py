...
if prompt: # is not None
    ...
    # container = st.chat_message("user")  # container를 가져오기. role: 'user' -> 입력문자를 구분하기 위한 값
    # container.write(prompt)             # container에 글을 출
    with st.chat_message("user"): # container를 가져오기. role: 'user' -> 입력문자를 구분하기 위한 값
        st.write(prompt) 
    
    
    # container = st.chat_message("ai")
    # container.write(ai_message)
    with st.chat_message("ai"): # container를 가져오기. role: 'user' -> 입력문자를 구분하기 위한 값
        st.write(ai_message) 